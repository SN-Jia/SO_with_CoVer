...
def beam_search_pointer(args, model, input_ids, attention_mask=None, token_type_ids=None,
    ...
    for t in range(target_t):
        ...
        print(f'pointed mask: shape:{pointed_mask.shape} {pointed_mask}')
        print(f'rela mask: shape:{rela_mask.shape} {rela_mask}')
        print(f'l1 mask: shape:{l1_mask.shape} {l1_mask}')
        print(f'l2 mask: shape:{l2_mask.shape} {l2_mask}')
        ...
        print(f'remain list: {remain_list}')
    ...
    print(f'done hyp_list: {hyp_list}')
